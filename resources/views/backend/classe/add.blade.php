            ...
            <div class="card">
                <div class="container-fluid">
                    <div class="py-5 w-50 mx-auto">
                        <form class="form-horizontal" action="{{route('store_classe')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-2 mb-4">
                                <label class="col-sm-3 form-label" for="name">Nom de la classe</label>
                                <div class="col-sm-9">
                                    <input class="form-control" required id="name" name="nom" type="text" placeholder="Nom de la classe">
                                </div>
                            </div>
                            <div class="row gy-2 mb-4">
                                <label class="col-sm-3 form-label" for="picture">Image</label>
                                <div class="col-sm-9">
                                    <input class="form-control" required id="picture" name="image" type="file" placeholder="Choissiez votre image" accept=".png, .jpeg, .jpg">
                                </div>
                            </div>
                            <div class="row">
