            ...
            <div class="card">
                ...
                <div class="container-fluid">
                    <div class="py-5 w-50 mx-auto">
                        <form class="form-horizontal" action="{{route('store_collaborateur')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row gy-2 mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" required id="title" name="nomComplet" type="text" placeholder="Nom Complet"><!--small class="form-text">Example help text that remains unchanged.</small>-->
                                </div>
                            </div>
                            <div class="row gy-2 mb-4">
                                <label class="col-sm-3 form-label" for="content">Poste</label>
                                <div class="col-sm-9">
                                    <input class="form-control" required id="content" name="poste" placeholder="Votre Poste"/>
                            ...
                            <div class="row gy-2 mb-4">
                                <label class="col-sm-3 form-label" for="describe">Adresse Email</label>
                                <div class="col-sm-9">
                                    <input class="form-control" required id="describe" name="email" type="email" placeholder="Votre adresse email"><!--small class="form-text">Example help text that remains unchanged.</small>-->
                                </div>
                            </div>
                            <!--<div class="row gy-2 mb-4">
